...
**[Download EUG Airport 0.9.1 comparison build](https://github.com/Brusko25/Eugene-Airport-Releases/releases/download/v0.9.1/EUG-Airport-v0.9.1-debug.apk)**

> **Latest: 0.9.1 comparison build — physical-phone verification pending.** This rebuilds
> the withdrawn 0.9 application's source with new version identifiers to test the normal
> in-app update path. Local tests and emulator compatibility passed; the earlier Play
> Protect block remains unexplained. The verified [0.8.1 release](https://github.com/Brusko25/Eugene-Airport-Releases/releases/tag/v0.8.1)
> remains available unchanged. Version 0.9.0 stays withdrawn.

## Screenshots

Actual EUG Airport 0.9.1 running in an Android emulator. These previews do not establish
...
| Departures | Arrivals |
| --- | --- |
| <a href="images/v0.9.1/departures.png"><img src="images/v0.9.1/departures.png" alt="0.9.1 departure board with destinations, times, gates and flight status" width="280"></a> | <a href="images/v0.9.1/arrivals.png"><img src="images/v0.9.1/arrivals.png" alt="0.9.1 arrival board with origins, times, gates and flight status" width="280"></a> |

| Airport guide | What's new |
| --- | --- |
| <a href="images/v0.9.1/airport-guide.png"><img src="images/v0.9.1/airport-guide.png" alt="0.9.1 airport guide with dining, parking, transport and accessibility" width="280"></a> | <a href="images/v0.9.1/whats-new.png"><img src="images/v0.9.1/whats-new.png" alt="What's new in 0.9.1 with the retained 0.9 feature summary" width="280"></a> |
