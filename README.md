...
**[Download EUG Airport 0.9.0](https://github.com/Brusko25/Eugene-Airport-Releases/releases/download/v0.9.0/EUG-Airport-v0.9.0-debug.apk)**

## Screenshots

Screenshots from EUG Airport 0.9.0 running in an Android emulator. Flight details, times and menu prices reflect the captured screen and can change. Click any image to see it full size.

| Departures | Arrivals |
| --- | --- |
| <a href="images/v0.9.0/departures.png"><img src="images/v0.9.0/departures.png" alt="Departure board with destinations, times, gates and flight status" width="280"></a> | <a href="images/v0.9.0/arrivals.png"><img src="images/v0.9.0/arrivals.png" alt="Arrival board with origins, times, gates and flight status" width="280"></a> |

| Airport guide | Food and drink |
| --- | --- |
| <a href="images/v0.9.0/airport-guide.png"><img src="images/v0.9.0/airport-guide.png" alt="Airport guide with dining, parking, transport and accessibility" width="280"></a> | <a href="images/v0.9.0/dining.png"><img src="images/v0.9.0/dining.png" alt="Airport dining with cafe choices and breakfast menu" width="280"></a> |


### What's new after updating

<a href="images/v0.9.0/whats-new.png"><img src="images/v0.9.0/whats-new.png" alt="Version 0.9 release highlights shown once after updating and available again from Settings" width="280"></a>
...
Versions **0.8.0 and newer** check for a newer release when you open the app. Tap **Update** to
...
If you still have **0.6 or 0.7**, use **Settings → App updates** to download 0.9 through
your browser once. Future updates can use the in-app flow.
